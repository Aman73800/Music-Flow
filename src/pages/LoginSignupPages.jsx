...
import { Eye, EyeOff, Mail, Lock, User, Music, AlertCircle, CheckCircle } from 'lucide-react';
...
function Login({ onToggleToSignup }) {
  ...
  return (
    <div className="w-full ml-50% max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">Sign in to your MusicFlow account</p>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
        <div className="space-y-6">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 bg-white/5 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-all duration-200 ${
                  errors.email 
                    ...
                    : 'border-gray-600 focus:border-pink-400 focus:ring-pink-400/50'
                }`}
          ...
          <div className="text-right">
            <button className="text-sm text-pink-400 hover:text-pink-300 transition-colors duration-200">
              Forgot Password?
            </button>
          </div>
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-2"
          >
  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">Join MusicFlow</h1>
        <p className="text-gray-400">Create your account and start discovering music</p>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
        <div className="space-y-6">
          ...
          <div className="text-sm text-gray-400">
            ...
            <button className="text-pink-400 hover:text-pink-300 transition-colors duration-200">
              Terms of Service
            </button>{' '}
            and{' '}
            <button className="text-pink-400 hover:text-pink-300 transition-colors duration-200">
...
export default function LoginSignupPages() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {currentPage === 'login' ? (
          <Login onToggleToSignup={() => setCurrentPage('signup')} />
        ) : (
          <Signup onToggleToLogin={() => setCurrentPage('login')} />
        )}
      </div>
    </div>
  );
